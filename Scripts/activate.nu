...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\v.minibaev.CENTRIKT\Desktop\telegrambot'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\v.minibaev.CENTRIKT\Desktop\telegrambot\Scripts\deactivate.nu'
